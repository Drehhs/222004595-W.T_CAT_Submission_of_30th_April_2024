...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li>
                <a href="index.php#report">Post an Announcement</a>
            </li>
            <li>
                <a href="lost.php">Lost Animals</a>
            </li>
    ...
    <main>
        ...
        <section>
            <div class="search_form">
                <form autocomplete="off" action="foundsearch.php" method="GET" target="_self">
                    ...
                    <a href="found.php" class="btn-readmore">Clear Filter</a>
                </form>
            </div>
        </section>
        ...
        <section>
            ...
            if (isset($_GET['search'])) {
                ...
                $query = "SELECT * FROM found WHERE CONCAT(name,species,breed,gen,city,description) LIKE '%$filtervalues%'";
                ...
                if (mysqli_num_rows($query_run) > 0) {
                    foreach ($query_run as $items) {
                        ...
                        echo "<a href=foundinfo.php?id=$items[id]>"; ?>
                        <img src="img/found/<?php echo $items['image']; ?>" alt="Card Image"> <?php echo "</a> </div>";
                        ...
                        echo "</table>";
                        echo "<br>";
                        echo "<a href=foundinfo.php?id=$items[id] class=btn-readmore>Details</a>";
                        echo '</div> </div>';
                    }
                } else {
